 ...
 * 
 */
@WebServiceClient(name = "SayHelloImplService", targetNamespace = "http://webservice.jianyu.com/", wsdlLocation = "http://localhost:17080/baozi/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOIMPLSERVICE_QNAME = new QName("http://webservice.jianyu.com/", "SayHelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:17080/baozi/hello?wsdl");
    ...
    public SayHelloImpl getSayHelloImplPort() {
        return super.getPort(new QName("http://webservice.jianyu.com/", "SayHelloImplPort"), SayHelloImpl.class);
    }
    ...
    public SayHelloImpl getSayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.jianyu.com/", "SayHelloImplPort"), SayHelloImpl.class, features);
    }
